<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="WebApplication1.Account.Login" %>
...
<form id="form1" runat="server" class="w-full max-w-md mx-auto">
    ...
    <div class="animated-card-gradient w-full mx-auto">
        <div class="form-card-container rounded-2xl p-4 md:p-6 z-20">
            <h1 class="text-2xl font-bold text-center dynamic-text-color mb-3">Login</h1>
            ...
            <p class="mt-3 text-center text-gray-500 text-sm">
                Don't have an account? <a href="Register.aspx" class="text-blue-500 hover:underline">Register</a>
            </p>
            <p class="mt-1 text-center text-gray-500 text-sm">
                <a href="ForgotPassword.aspx" class="text-blue-500 hover:underline">Forgot password?</a>
            </p>
        </div>
    </div>
</form>
