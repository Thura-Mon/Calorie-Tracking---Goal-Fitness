<%@ Page Title="User Profile" Language="C#" AutoEventWireup="true" CodeFile="Userprofile.aspx.cs" Inherits="WebApplication1.User.Userprofile" %>
...
<head runat="server">
    ...
    <title>Tu Kha - User Profile</title>
    ...
    <style>
        ...
        body.dark .profile-label { color: #ccc; }
...
<body>
    ...
    <nav class="topbar">
        ...
        <div class="nav-menu">
            ...
            <a href="Userprofile.aspx" class="active" >Profile</a>
    ...
    <form id="form1" runat="server" class="container mx-auto p-4 md:p-8 mt-20 md:mt-24">
        ...
        <div class="animated-card-gradient w-full max-w-2xl mx-auto">
            <div class="user-card-container rounded-2xl p-8 z-20">
                <h1 class="text-3xl font-bold text-center dynamic-text-color mb-6">User Profile</h1>
                
                <div id="messageContainer" runat="server"></div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                    <div class="col-span-1 md:col-span-2">
                        <label for="txtEmail" class="profile-label dynamic-text-color">Email</label>
                        <asp:TextBox ID="txtEmail" runat="server" CssClass="profile-input" ReadOnly="true" />
                    </div>

                    <div>
                        <label for="txtName" class="profile-label dynamic-text-color">Name</label>
                        <asp:TextBox ID="txtName" runat="server" CssClass="profile-input" />
                    </div>
                    
                    <div>
                        <label for="txtAge" class="profile-label dynamic-text-color">Age</label>
                        <asp:TextBox ID="txtAge" runat="server" CssClass="profile-input" TextMode="Number" />
                    </div>

                    <div>
                        <label for="txtGender" class="profile-label dynamic-text-color">Gender</label>
                        <asp:TextBox ID="txtGender" runat="server" CssClass="profile-input" />
                    </div>
                    
                    <div>
                        <label for="txtGoal" class="profile-label dynamic-text-color">Goal</label>
                        <asp:DropDownList ID="txtGoal" runat="server" CssClass="profile-input">
                            <asp:ListItem Text="Lose Weight" Value="Lose Weight"></asp:ListItem>
                            <asp:ListItem Text="Maintain Weight" Value="Maintain Weight"></asp:ListItem>
                            <asp:ListItem Text="Gain Weight" Value="Gain Weight"></asp:ListItem>
                        </asp:DropDownList>
                    </div>

                    <div>
                        <label for="txtWeight" class="profile-label dynamic-text-color">Weight (kg)</label>
                        <asp:TextBox ID="txtWeight" runat="server" CssClass="profile-input" TextMode="Number" />
                    </div>

                    <div>
                        <label for="txtHeight" class="profile-label dynamic-text-color">Height (cm)</label>
                        <asp:TextBox ID="txtHeight" runat="server" CssClass="profile-input" TextMode="Number" />
                    </div>
                </div>
