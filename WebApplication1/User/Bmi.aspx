<%@ Page Title="BMI Calculator" Language="C#" AutoEventWireup="true" CodeFile="Bmi.aspx.cs" Inherits="WebApplication1.User.Bmi" %>
...
<head runat="server">
    ...
    <title>Tu Kha - BMI Calculator</title>
...
<body class="<%= GetThemeClass() %>">
    ...
    <nav class="topbar">
        ...
        <div class="nav-menu">
            ...
            <a href="Bmi.aspx" class="active" >BMI</a>
    ...
    <form id="form1" runat="server" class="container mx-auto p-4 md:p-8 mt-20 md:mt-24">
        ...
        <div class="animated-card-gradient w-full max-w-3xl mx-auto">
            <div id="bmiCard" class="bmi-card-container rounded-2xl p-8 dark:bg-[#1a1a2e] dark:text-[#e0e0e0] z-20">
                <h1 class="text-3xl font-bold text-center dynamic-text-color mb-4">Your BMI Result</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 text-center md:text-left">
                    <div>
                        ...
                        <p class="text-sm dynamic-text-color">Here is your Body Mass Index (BMI).</p>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <p class="text-5xl font-extrabold text-cyan-500 mb-2">
                        <asp:Label ID="lblBmiValue" runat="server"></asp:Label>
                    </p>
                    <p class="text-lg font-semibold dynamic-text-color">Your BMI</p>
                </div>

                <div class="mt-6 text-center">
                    <div id="commentBox" runat="server" class="p-4 comment-box-base">
                        <p class="text-2xl font-bold mb-1">Status</p>
                        <p class="text-lg leading-relaxed"><asp:Label ID="lblBmiCategory" runat="server"></asp:Label></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        class ParticleSystem {
            constructor(canvasId) {
                ...
                // Now listening to mouse movements on the entire window
        ...
        // Initialize the particle system to cover the entire window
